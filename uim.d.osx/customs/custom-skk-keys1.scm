...
(define skk-latin-key '("zenkaku-hankaku" "<Shift> " "<IgnoreCase>x"))
(define skk-latin-key? (make-key-predicate '("zenkaku-hankaku" "<Shift> " "<IgnoreCase>x")))
(define skk-wide-latin-key '("<IgnoreCase><Shift>x"))
(define skk-wide-latin-key? (make-key-predicate '("<IgnoreCase><Shift>x")))
